...
// InteractiveNebulaShader For info cards and other components 
...
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    if (mat) {
      ...
      mat.uniforms.shiftX.value = shiftX;
    }
  }, [hasActiveReminders, hasUpcomingReminders, disableCenterDimming, shiftX]);
